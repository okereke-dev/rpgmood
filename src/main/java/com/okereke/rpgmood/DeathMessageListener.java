...
public class DeathMessageListener implements Listener {
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        if (message != null && !message.isBlank()) {
            // Fire API event
            com.okereke.rpgmood.api.PlayerDeathMessageEvent apiEvent =
                    new com.okereke.rpgmood.api.PlayerDeathMessageEvent(player, message, causeKey, biomeKey, killerKey);
